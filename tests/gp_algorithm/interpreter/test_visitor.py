...
@pytest.mark.parametrize(
    ...
    [
        ("v420 = 0", Expression(8643), Expression(0)),
        ("v420 = true", Expression(False), CONST_TRUE),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("true > false", CONST_TRUE),
        ("true > true", CONST_FALSE),
        ("false - false", Expression(0)),
        ("false - true", Expression(-1)),
        ("true - false", Expression(1)),
        ("true - true", Expression(0)),
        ("false + false", Expression(0)),
        ("false + true", Expression(1)),
        ("true + false", Expression(1)),
        ("true + true", Expression(2)),
        ("false * false", Expression(0)),
        ("false * true", Expression(0)),
        ("true * false", Expression(0)),
        ("true * true", Expression(1)),
        ("false / true", Expression(0)),
        ("1 and 0", CONST_FALSE),
        ("(1 and 1)", CONST_TRUE),
        ("0 and 1", CONST_FALSE),
